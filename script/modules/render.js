...
// const handleEditButtonClick = async (e) => {   deep
//   const row = e.target.closest('tr');
//   const goodId = row.querySelector('.thead-crm__item').textContent.trim();
...
//         if (changes.title) {
//           row.querySelector('.thead-crm__item:nth-child(2)').textContent = changes.title;
//         }
//         if (changes.category) {
//           row.querySelector('.thead-crm__item:nth-child(3)').textContent = changes.category;
//         }
//         if (changes.units) {
//           row.querySelector('.thead-crm__item:nth-child(4)').textContent = changes.units;
//         }
//         if (changes.count) {
//           row.querySelector('.thead-crm__item:nth-child(5)').textContent = changes.count;
//         }
//         if (changes.price) {
//           row.querySelector('.thead-crm__item:nth-child(6)').textContent = `$${changes.price}`;
//         }

//         const discountValue = +changes.discount || +good.discount || 0;
//         let totalPrice = +changes.price || +good.price * +changes.count || +good.count;

//         if (discountValue > 0) {
//           const discountAmount = (+changes.price || +good.price * discountValue) / 100;
//           totalPrice =
//             (+changes.price || +good.price - discountAmount) * +changes.count || +good.count;
//         }
